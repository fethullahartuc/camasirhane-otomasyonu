namespace Ivedi_Yikama
{
    partial class Teslim_Listesi
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Teslim_Listesi));
            ...
            dataGridView_teslim = new DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridView_teslim).BeginInit();
            SuspendLayout();
            // 
            // panel_ekran
            // 
            ...
            panel_ekran.Controls.Add(btn_teslim);
            ...
            // btn_teslim
            // 
            btn_teslim.Location = new Point(237, 13);
            btn_teslim.Name = "btn_teslim";
            btn_teslim.Size = new Size(109, 47);
            btn_teslim.TabIndex = 52;
            btn_teslim.Text = "Teslim Et";
            btn_teslim.UseVisualStyleBackColor = true;
            btn_teslim.Click += btn_teslim_Click;
            // 
            // dataGridView_teslim
            // 
            dataGridView_teslim.AllowUserToAddRows = false;
            dataGridView_teslim.AllowUserToDeleteRows = false;
            dataGridView_teslim.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridView_teslim.BackgroundColor = Color.Gainsboro;
            dataGridView_teslim.Columns.AddRange(new DataGridViewColumn[] { id, adi, soyadi, telefon, adres, siparis_tarihi });
            dataGridView_teslim.Location = new Point(14, 97);
            dataGridView_teslim.Name = "dataGridView_teslim";
            dataGridView_teslim.ReadOnly = true;
            dataGridView_teslim.RowHeadersVisible = false;
            dataGridView_teslim.Size = new Size(776, 271);
            dataGridView_teslim.TabIndex = 56;
            dataGridView_teslim.CellClick += dataGridView_teslim_CellClick;
            // 
            // id
            // 
            ...
            Controls.Add(dataGridView_teslim);
            FormBorderStyle = FormBorderStyle.FixedDialog;
            Icon = (Icon)resources.GetObject("$this.Icon");
            MaximizeBox = false;
            Name = "Teslim_Listesi";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Teslim Edilecekler Listesi";
            FormClosing += Teslim_Listesi_FormClosing;
            Load += Teslim_Listesi_Load;
            panel_ekran.ResumeLayout(false);
            panel_ekran.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridView_teslim).EndInit();
            ResumeLayout(false);
        }
        ...
        private DataGridView dataGridView_teslim;
